...
sc1 = {
    ...
    draw:function(time){
        ...
        if(varR){
            ...
            tree.metaBalls.setSize(140);
            tree.metaBalls.setResolution(420);
            tree.metaBalls.ballSize = .11;
        ...
        if(var1){
             if(varT){
                ...
                var ob = {zero:1,xy:0,divx:60,divy:10,off:{func:function(t){var p=0;if(t<8)p=10;return p;},points:1,freq:.5,mult:1,tipNoiseMult:5,tipNoiseFreq:.1,tipOff:-2,tipLength:2,tipPoint:0.01},
                    tubeArgs:{lengthSegs:12,widthSegs:1,minWidth:0.01,width:2}};
                var ob2 = {zero:1,xy:0,divx:60,divy:10,off:{func:function(t){var p=0;if(t<8)p=10;return p;},points:1,freq:.5,mult:1,tipNoiseMult:5,tipNoiseFreq:.1,tipOff:2,tipLength:2,tipPoint:0.01},
                    tubeArgs:{lengthSegs:12,widthSegs:1,minWidth:0.01,width:2}};
                ...
                holder.add(weave(mothParts[6],{divx:22,divy:2,zero:4,off:{skip:true},tubeArgs:{lengthSegs:6,widthSegs:2,minWidth:.2,width:.5}}));
                holder.add(weave(mothParts[7],{divx:22,divy:2,zero:4,off:{skip:true},tubeArgs:{lengthSegs:6,widthSegs:2,minWidth:.2,width:.5}}));
                holder.add(weave(mothParts[8],{divx:12,divy:10,zero:3,off:{skip:true},tubeArgs:{lengthSegs:6,widthSegs:5,minWidth:.2,width:.5}}));
                holder.add(weave(mothParts[9],{divx:12,divy:10,zero:3,off:{skip:true},tubeArgs:{lengthSegs:6,widthSegs:5,minWidth:.2,width:.5}}));
                // weave(mothParts[11],2,1);
               
                // scene.add(geo);
                for(var i = 0 ; i < mothParts.length-1 ; i++){
                    if(i>5 && i!=10) //wings
                    holder.add(mothParts[i].makeTubes({widthSegs:4,lengthSegs:18,width:1.3,minWidth:.1,func:function(t){return Math.sin(((t)/2)-1.5)*2}}));
                    if(i==10)//head
        ...
        if(!var1){
             if(varT){
                ...
                // var ob = {zero:1,xy:0,divx:30,divy:10,off:{func:function(t){var p=0;if(t<8)p=10;return p;},points:1,freq:.8,mult:1,tipNoiseMult:5,tipNoiseFreq:.2,tipOff:-4,tipLength:3,tipPoint:0.01},
                //     tubeArgs:{lengthSegs:12,widthSegs:1,minWidth:0.01,width:2}};
                // var ob2 = {zero:1,xy:0,divx:30,divy:10,off:{func:function(t){var p=0;if(t<8)p=10;return p;},points:1,freq:.8,mult:1,tipNoiseMult:5,tipNoiseFreq:.2,tipOff:4,tipLength:3,tipPoint:0.01},
                //     tubeArgs:{lengthSegs:12,widthSegs:1,minWidth:0.01,width:2}};
                ...
                // }
                var ob = {zero:1,xy:0,divx:30,divy:10,off:{func:function(t){var p=0;if(t<8)p=10;return p;},points:1,freq:.5,mult:1,tipNoiseMult:5,tipNoiseFreq:.1,tipOff:-5,tipLength:3,tipPoint:0.01},
                tubeArgs:{lengthSegs:12,widthSegs:1,minWidth:0.01,width:2}};
                var ob2 = {zero:1,xy:0,divx:30,divy:10,off:{func:function(t){var p=0;if(t<8)p=10;return p;},points:1,freq:.5,mult:1,tipNoiseMult:5,tipNoiseFreq:.1,tipOff:5,tipLength:3,tipPoint:0.01},
                    tubeArgs:{lengthSegs:12,widthSegs:1,minWidth:0.01,width:2}};
                ...
                holder.add(weave(mothParts[6],{divx:22,divy:2,zero:4,off:{skip:true},tubeArgs:{lengthSegs:6,widthSegs:1,minWidth:.2,width:.5}}));
                holder.add(weave(mothParts[7],{divx:22,divy:2,zero:4,off:{skip:true},tubeArgs:{lengthSegs:6,widthSegs:1,minWidth:.2,width:.5}}));
                holder.add(weave(mothParts[8],{divx:7,divy:10,zero:3,off:{skip:true},tubeArgs:{lengthSegs:6,widthSegs:5,minWidth:.4,width:1.3}}));
                holder.add(weave(mothParts[9],{divx:7,divy:10,zero:3,off:{skip:true},tubeArgs:{lengthSegs:6,widthSegs:5,minWidth:.4,width:1.3}}));
                // weave(mothParts[11],2,1);
               
                // scene.add(geo);
                for(var i = 0 ; i < mothParts.length-1 ; i++){
                    if(i>5 && i!=10) //wings
                    holder.add(mothParts[i].makeTubes({widthSegs:3,lengthSegs:18,width:1.3,minWidth:.1,func:function(t){return Math.sin(((t)/2)-1.5)*2}}));
                    if(i==10)//head
                    holder.add(mothParts[i].makeTubes({widthSegs:2,lengthSegs:8,width:.1,minWidth:.1}));
...
return JSON.parse('{"body":{"bodyRX":0,"bodyRY":0,"bodyRZ":0,"abdomenRX":0,"abdomenRY":0,"abdomenRZ":0,"thoraxRX":-0.0979563072586328,"thoraxRY":0,"thoraxRZ":0},"anim":{"flapHeight":0,"flapSpeed":0,"jiggly":1},"head":{"symmetry":0,"headRX":-0.5,"headRY":0,"headRZ":0,"leftAntRootRX":-0.34601832276250877,"leftAntRootRY":0.03735024665257214,"leftAntRootRZ":-0.23326286116983797,"leftAntAllRX":0.3756166314305849,"leftAntAllRY":0,"leftAntAllRZ":0,"rightAntRootRX":0.3305144467935166,"rightAntRootRY":-0.1430584918957012,"rightAntRootRZ":-0.18816067653276958,"rightAntAllRX":-0.4136715997181113,"rightAntAllRY":0,"rightAntAllRZ":0,"probAllRX":0,"probAllRY":0,"probAllRZ":0,"probRootRX":0,"probRootRY":0,"probRootRZ":0,"nFreqLeft":0.5560253699788584,"nFreqRight":0.4432699083861875,"nMultLeft":0.46582100070472165,"nMultRight":0.30796335447498246},"wings":{"LeftWingRootRX":0,"LeftWingRootRY":0,"LeftWingRootRZ":0,"RightWingRootRX":0,"RightWingRootRY":0,"RightWingRootRZ":0,"LUWingRootRX":0.0599013389711065,"LUWingRootRY":-0.007751937984496138,"LUWingRootRZ":-0.07540521494009866,"LUWingAllRX":-0.0979563072586328,"LUWingAllRY":0,"LUWingAllRZ":0,"LUWingVeinsAllRX":0.08245243128964064,"LUWingVeinsAllRY":0,"LUWingVeinsAllRZ":0,"LLWingRootRX":0,"LLWingRootRY":0,"LLWingRootRZ":-0.052854122621564525,"LLWingAllRX":0,"LLWingAllRY":0,"LLWingAllRZ":0,"LLWingVeinsAllRX":0.08245243128964064,"LLWingVeinsAllRY":0,"LLWingVeinsAllRZ":0,"RUWingRootRX":-0.007751937984496138,"RUWingRootRY":-0.007751937984496138,"RUWingRootRZ":0.08245243128964064,"RUWingAllRX":0,"RUWingAllRY":0,"RUWingAllRZ":0,"RUWingVeinsAllRX":0.12755461592670891,"RUWingVeinsAllRY":0,"