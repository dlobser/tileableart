...
function reinit() {
	...
	if(!noLights){
		...
		light = new THREE.DirectionalLight( 0x555555,1,0 ); light.position.set( -1, -1, -1 ); scene.add( light );
		light = new THREE.DirectionalLight( 0x666666,1,0 ); light.position.set( 1, -1, 1 ); scene.add( light );
